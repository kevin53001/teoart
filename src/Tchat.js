  ...
  return (
    <>
      ...
      <div
        ...
        style={{ position: 'fixed', top: '58px', right: '16px', zIndex: 1000, cursor: 'pointer', userSelect: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      >
        <img src={`${R2}/site/pastille_chat.png`} alt="Tchat" style={{ width: '30px', height: '30px', objectFit: 'contain', filter: nbNonLuTotal > 0 ? 'drop-shadow(0 0 4px rgba(255,62,181,0.6))' : 'none' }} />
        {nbNonLuTotal > 0 && (
