...
function VignetteDossier({ livre, taille = 150, onClick }) {
    ...
    <div ref={wrapRef} style={{ perspective: '800px', flexShrink: 0 }}>
      <div ref={cardRef}
        ...
        style={{
          ...
          boxShadow: '0 2px 8px rgba(0,0,0,0.6), 0 8px 24px rgba(0,0,0,0.7), 0 0 12px rgba(255,210,80,0.06)',
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse at 30% 20%, rgba(255,210,80,0.06) 0%, transparent 60%), radial-gradient(ellipse at 70% 80%, rgba(0,212,212,0.04) 0%, transparent 60%)',
          pointerEvents: 'none',
        }} />

        {/* Lignes décoratives */}
        <div style={{ position: 'absolute', top: '12px', left: '12px', right: '12px', height: '1px', background: 'linear-gradient(to right, transparent, rgba(255,210,80,0.3), transparent)' }} />
        <div style={{ position: 'absolute', bottom: '40px', left: '12px', right: '12px', height: '1px', background: 'linear-gradient(to right, transparent, rgba(255,210,80,0.3), transparent)' }} />

        {/* Icône dossier */}
        <div style={{ fontSize: taille > 120 ? '28px' : '20px', marginBottom: '8px', opacity: 0.7 }}>📁</div>

        {/* Nom */}
        <p style={{
          color: 'rgba(255,255,255,0.85)',
          fontSize: taille > 120 ? '11px' : '9px',
          fontWeight: 'bold',
          textAlign: 'center',
          padding: '0 10px',
          lineHeight: '1.4',
          textShadow: '0 0 10px rgba(255,210,80,0.3)',
        }}>{livre.nom}</p>

        {livre.annee && (
          <p style={{ color: 'rgba(0,212,212,0.6)', fontSize: '10px', marginTop: '4px' }}>{livre.annee}</p>
        )}
        ...
        <div style={{
          ...
          borderTop: '1px solid rgba(255,210,80,0.15)',
        }}>
          <p style={{ color: 'rgba(255,210,80,0.6)', fontSize: '9px', letterSpacing: '1px', textTransform: 'uppercase' }}>Dossier</p>
        </div>
      </div>
    </div>
  );
